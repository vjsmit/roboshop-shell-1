"\e[33m Installing Maven\e[0m"
yum install maven -y &>>/tmp/roboshop.log

"\e[33mAdd application User \e[0m"
useradd roboshop &>>/tmp/roboshop.log

"\e[33ms\Setup an app directory. \e[0m"
...
"\e[33mDownload the dependencies & build the application \e[0m"
mvn clean package &>>/tmp/roboshop.log
mv target/shipping-1.0.jar shipping.jar &>>/tmp/roboshop.log

"\e[33mSetup a Shipping service \e[0m"
...
"\e[33mInstall mysql client. \e[0m"
...
"\e[33mRestart shipping service \e[0m"
systemctl restart shipping &>>/tmp/roboshop.log